...
export interface IConstantInflowNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IConstantInflowNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IConstantInflowNFT;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, newTokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
