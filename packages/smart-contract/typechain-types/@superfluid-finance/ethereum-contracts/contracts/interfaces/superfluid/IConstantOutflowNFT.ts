...
export declare namespace IFlowNFTBase {
  export type FlowNFTDataStruct = {
    ...
    flowSender: AddressLike;
    flowReceiver: AddressLike;
    flowStartDate: BigNumberish;
  };

  export type FlowNFTDataStructOutput = [
    superToken: string,
    flowSender: string,
    flowReceiver: string,
    flowStartDate: bigint
  ] & {
    superToken: string;
    flowSender: string;
    flowReceiver: string;
...
export interface IConstantOutflowNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IConstantOutflowNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IConstantOutflowNFT;
  ...
  flowDataByTokenId: TypedContractMethod<
    [tokenId: BigNumberish],
  ...
  onCreate: TypedContractMethod<
    [token: AddressLike, flowSender: AddressLike, flowReceiver: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "flowDataByTokenId"
  ): TypedContractMethod<
    [tokenId: BigNumberish],
    [IFlowNFTBase.FlowNFTDataStructOutput],
    "view"
