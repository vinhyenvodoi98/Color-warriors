...
import type {
  IPoolAdminNFT,
  IPoolAdminNFTInterface,
} from "../../../../../../../@superfluid-finance/ethereum-contracts/contracts/interfaces/agreements/gdav1/IPoolAdminNFT";
...
export class IPoolAdminNFT__factory {
  static readonly abi = _abi;
  static createInterface(): IPoolAdminNFTInterface {
    return new Interface(_abi) as IPoolAdminNFTInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPoolAdminNFT {
    return new Contract(address, _abi, runner) as unknown as IPoolAdminNFT;
  }
}
