...
import type {
  IPoolMemberNFT,
  IPoolMemberNFTInterface,
} from "../../../../../../../@superfluid-finance/ethereum-contracts/contracts/interfaces/agreements/gdav1/IPoolMemberNFT";
...
export class IPoolMemberNFT__factory {
  static readonly abi = _abi;
  static createInterface(): IPoolMemberNFTInterface {
    return new Interface(_abi) as IPoolMemberNFTInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPoolMemberNFT {
    return new Contract(address, _abi, runner) as unknown as IPoolMemberNFT;
  }
}
