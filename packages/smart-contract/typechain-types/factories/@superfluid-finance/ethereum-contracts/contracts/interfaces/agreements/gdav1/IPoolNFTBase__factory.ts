...
import type {
  IPoolNFTBase,
  IPoolNFTBaseInterface,
} from "../../../../../../../@superfluid-finance/ethereum-contracts/contracts/interfaces/agreements/gdav1/IPoolNFTBase";
...
export class IPoolNFTBase__factory {
  static readonly abi = _abi;
  static createInterface(): IPoolNFTBaseInterface {
    return new Interface(_abi) as IPoolNFTBaseInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPoolNFTBase {
    return new Contract(address, _abi, runner) as unknown as IPoolNFTBase;
  }
}
